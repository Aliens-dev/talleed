...
<div class="admin-sidebar">
    ...
    <div class="sidebar-body">
        <div class="sidebar-items">
            ...
            <a  href="{{ route('admin.contact.index') }}" class="sidebar-item ripple">
                <div class="icon">
                    <img src="/assets/img/envelope.svg" width="20" height="20" alt="">
                </div>
                <div class="text">الرسائل</div>
            </a>
            <a  href="{{ route('admin.menu.index') }}" class="sidebar-item ripple">
                <div class="icon">
