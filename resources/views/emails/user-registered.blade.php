                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; direction: rtl;" width="100%">
                                <tr>
                                    <td style="text-aligh: right; font-family: sans-serif; font-size: 14px; vertical-align: top; direction: rtl;" valign="top">
                                        <p style="text-aligh: right; font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; direction: rtl;">شكرا لتسجيلك في تليــد</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; box-sizing: border-box; width: 100%; direction: rtl;" width="100%">
                                            <tbody>
                                            <tr>
                                                <td align="right" style="text-aligh: right; font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px; direction: rtl;" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto; direction: rtl;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="text-aligh: right; font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db; direction: rtl;" valign="top" align="center" bgcolor="#3498db">
                                                                <a href="{{ url('/') . '/verify-email/' . $user->id . '/' .sha1($user->getEmailForVerification()) }}" target="_blank" style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #3498db; border-color: #3498db; color: #ffffff;">تفعيل الايميل</a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                        ...
                                        <div style="text-aligh: right; font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; direction: rtl;">                                            إذا كنت تواجه مشكلة في النقر على الزر "التحقق من عنوان البريد الإلكتروني" ، فانسخ عنوان URL أدناه والصقه في متصفح الويب لديك :
                                            <div>
                                                {{ url('/') . '/verify-email/' . $user->id . '/' .sha1($user->getEmailForVerification()) }}
                                            </div>
                                        </div>
